...
if (
  !index.includes('src="/alpine-js-swiper/assets/site.js"') &&
  !index.includes('src="./assets/site.js"')
) {
  throw new Error('Built page is missing the stable JavaScript asset');
}

if (
  !index.includes('href="/alpine-js-swiper/assets/site.css"') &&
  !index.includes('href="./assets/site.css"')
) {
